...
class PortfolioOptimizer:
    ...
    def download_data(self):
        ...
        try:
            with st.spinner('Downloading stock data...'):
                # Download all tickers in single request
                data = yf.download(
                ...
                # Rebuild DataFrame with available tickers
                ...
                # Update tickers list with successfully downloaded symbols
    ...
    def negative_sharpe_ratio(self, weights):
        ...
        if p_vol < 1e-6:  # Prevent division by zero
            return np.inf
